...
export function ShowsPage() {
    ...
    const fetchData = async () => {
      ...
      try {
        const [itemsResponse, genresResponse] = await Promise.all([
          jellyfinApi.get<JellyfinItemsResponse<MediaItem>>(`/Users/${userId}/Items?IncludeItemTypes=Series&Recursive=true&Fields=PrimaryImageAspectRatio,Genres`),
  ...
  return (
    <div ref={pageRef} className="p-6 md:p-8">
      <h1 className="text-5xl font-bold mb-8">TV Shows</h1>
      <SearchAndFilter
        genres={genres}
